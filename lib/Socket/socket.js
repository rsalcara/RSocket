...
import { addTransactionCapability, aesEncryptCTR, bindWaitForConnectionUpdate, bytesToCrockford, configureSuccessfulPairing, Curve, derivePairingCodeKey, generateLoginNode, generateMdTagPrefix, generateRegistrationNode, getCodeFromWSError, getErrorCodeFromStreamError, getNextPreKeysNode, getPlatformId, initPrometheus, logAuth, logConnection, logPreKeys, logQRGenerated, makeEventBuffer, makeNoiseHandler, promiseTimeout, signedKeyPair, validateRetryConfig, xmppSignedPreKey } from '../Utils/index.js';
...
export const makeSocket = (config) => {
    ...
    if (!retryValidation.valid) {
        throw new Boom(`Invalid retry configuration: ${retryValidation.errors.join(', ')}`, { statusCode: 500 });
    }
