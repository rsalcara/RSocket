...
const makeSocket = (config) => {
    ...
    const end = async (error) => {
        ...
        try {
            const prometheus = (0, prometheus_metrics_1.getPrometheus)();
            if (prometheus === null || prometheus === void 0 ? void 0 : prometheus.isEnabled()) {
                const jid = ((_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.id) || 'unknown';
                const connectionId = ((_c = (_b = authState.creds.me) === null || _b === void 0 ? void 0 : _b.id) === null || _c === void 0 ? void 0 : _c.split('@')[0]) || 'unknown';
    ...
    const waitForSocketOpen = async (timeoutMs = connectTimeoutMs) => {
        ...
        try {
            ...
            if (((_a = error === null || error === void 0 ? void 0 : error.output) === null || _a === void 0 ? void 0 : _a.statusCode) === Types_1.DisconnectReason.timedOut) {
    ...
    process.nextTick(() => {
        ...
        try {
            const prometheus = (0, prometheus_metrics_1.getPrometheus)();
            if (prometheus === null || prometheus === void 0 ? void 0 : prometheus.isEnabled()) {
                const jid = ((_b = authState.creds.me) === null || _b === void 0 ? void 0 : _b.id) || 'unknown';
                const connectionId = ((_d = (_c = authState.creds.me) === null || _c === void 0 ? void 0 : _c.id) === null || _d === void 0 ? void 0 : _d.split('@')[0]) || 'unknown';
    ...
    ws.on('CB:ib,,offline', (node) => {
        ...
        try {
            const prometheus = (0, prometheus_metrics_1.getPrometheus)();
            if ((prometheus === null || prometheus === void 0 ? void 0 : prometheus.isEnabled()) && offlineNotifs > 0) {
