...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    createParticipantNodes: (jids: string[], message: import("../Types/index.js").WAProto.IMessage, extraAttrs?: BinaryNode["attrs"], lid?: string, meid?: string, melid?: string, dsmMessage?: import("../Types/index.js").WAProto.IMessage) => Promise<{
        nodes: BinaryNode[];
