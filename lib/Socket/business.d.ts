...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    createParticipantNodes: (jids: string[], message: import("../Types").WAProto.IMessage, extraAttrs?: BinaryNode["attrs"], lid?: string, meid?: string, melid?: string, dsmMessage?: import("../Types").WAProto.IMessage) => Promise<{
        nodes: BinaryNode[];
