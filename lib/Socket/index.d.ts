...
import { clearWaVersionCache, getCachedWaVersion } from '../Utils/generics';
/**
...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    createParticipantNodes: (jids: string[], message: import("../Types").WAProto.IMessage, extraAttrs?: import("..").BinaryNode["attrs"], lid?: string, meid?: string, melid?: string, dsmMessage?: import("../Types").WAProto.IMessage) => Promise<{
    ...
    updateBlockStatus: (jidOrPn: string, action: "block" | "unblock") => Promise<void>;
 ...
 * })
 */
export declare const makeWASocketAsync: (config: UserFacingSocketConfig) => Promise<{
    logger: import("../Utils/logger").ILogger;
    getOrderDetails: (orderId: string, tokenBase64: string) => Promise<import("../Types").OrderDetails>;
    getCatalog: ({ jid, limit, cursor }: import("../Types").GetCatalogOptions) => Promise<{
        products: import("../Types").Product[];
