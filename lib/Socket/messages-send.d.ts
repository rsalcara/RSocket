...
import { AnyMessageContent, MediaConnInfo, MessageReceiptType, MessageRelayOptions, MiscMessageGenerationOptions, SocketConfig, WAMessage, WAMessageKey } from '../Types';
...
export declare const makeMessagesSocket: (config: SocketConfig) => {
    ...
    createParticipantNodes: (jids: string[], message: proto.IMessage, extraAttrs?: BinaryNode["attrs"], lid?: string, meid?: string, melid?: string, dsmMessage?: proto.IMessage) => Promise<{
        nodes: BinaryNode[];
