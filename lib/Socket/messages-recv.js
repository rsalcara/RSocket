...
const makeMessagesRecvSocket = (config) => {
    ...
    const prekeyCircuitBreaker = (0, Utils_1.createPreKeyCircuitBreaker)(logger);
    // Log initialization (controlled by BAILEYS_LOG environment variable)
    (0, Utils_1.baileysLog)('🔧 Circuit Breaker initialized - Threshold: 5 failures/60s, Timeout: 30s');
    logger.warn({
    ...
    const msgRetryCache = config.msgRetryCounterCache ||
        new node_cache_1.default({
            ...
            maxKeys: Defaults_1.DEFAULT_CACHE_MAX_KEYS.MSG_RETRY, // 10,000 keys (memory leak prevention)
            deleteOnExpire: true,
            useClones: false
        });
    const callOfferCache = config.callOfferCache ||
        new node_cache_1.default({
            ...
            maxKeys: Defaults_1.DEFAULT_CACHE_MAX_KEYS.CALL_OFFER, // 500 keys (memory leak prevention)
            deleteOnExpire: true,
            useClones: false
        });
            ...
            if (retryCount <= 2 && forceIncludeKeys) {
                ...
                content.push({
                    ...
                    content: [
                        ...
                        (0, Utils_1.xmppPreKey)(preKey, +keyId),
    ...
    const handleReceipt = async (node) => {
        ...
        if (remoteJid && shouldIgnoreJid(remoteJid) && remoteJid !== WABinary_1.S_WHATSAPP_NET) {
    ...
    const handleMessage = async (node) => {
        ...
        if (msg.messageStubType === WAProto_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
            if (((_c = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _c === void 0 ? void 0 : _c[0]) === Utils_1.MISSING_KEYS_ERROR_TEXT ||
                ((_d = msg.messageStubParameters) === null || _d === void 0 ? void 0 : _d[0]) === Utils_1.NO_MESSAGE_FOUND_ERROR_TEXT) {
        ...
        try {
            await Promise.all([
                processingMutex.mutex(async () => {
                    ...
                    if (msg.messageStubType === WAProto_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
                        ...
                        retryMutex.mutex(async () => {
                            if (ws.isOpen) {
                                ...
                                if (!prekeyCircuitBreaker.canExecute()) {
                                    ...
                                    (0, Utils_1.baileysLog)(`🔴 Circuit Breaker OPEN - Blocking retry. State: ${stats.state}, Wait: ${Math.round(stats.timeUntilHalfOpen / 1000)}s`);
                                    logger.warn({
                                        msgId: msg.key.id,
                                ...
                                try {
                                    ...
                                    (0, Utils_1.logMessage)('decrypt_failed', { messageId: msgId, retryCount: retryCount + 1, maxRetries });
                                    // Calculate exponential backoff with jitter
                                    if (retryCount > 0) {
                                        const backoffDelay = (0, Utils_1.getBackoffDelay)(retryCount, config);
                                        logger.debug({ msgId, retryCount, backoffDelay }, 'Applying exponential backoff with jitter before retry');
                                    ...
                                    (0, Utils_1.baileysLog)(`✅ Message retry successful - CB State: ${cbStats.state}, Failures: ${cbStats.failures}, RetryCount: ${retryCount}`);
                                    logger.warn({
                                        component: 'CircuitBreaker',
                                        msgId,
                                        retryCount,
                                    ...
                                    logger.error({ msgId: msg.key.id, error: err.message }, 'Retry request failed');
                        ...
                        if (!isNewsletter) {
                            ...
                            if (category === 'peer') {
                                ...
                                type = 'sender';
                                if ((0, WABinary_1.isJidUser)(msg.key.remoteJid) || (0, WABinary_1.isLidUser)(msg.key.remoteJid)) {
                                    participant = author;
                                }
                            }
                    ...
                    if (prometheus === null || prometheus === void 0 ? void 0 : prometheus.isEnabled()) {
                        const messageType = ((_b = msg.message) === null || _b === void 0 ? void 0 : _b.conversation) ? 'text' :
                            ((_c = msg.message) === null || _c === void 0 ? void 0 : _c.imageMessage) ? 'image' :
                                ((_d = msg.message) === null || _d === void 0 ? void 0 : _d.videoMessage) ? 'video' :
                                    ((_e = msg.message) === null || _e === void 0 ? void 0 : _e.audioMessage) ? 'audio' :
                                        ((_f = msg.message) === null || _f === void 0 ? void 0 : _f.documentMessage) ? 'document' :
                                            ((_g = msg.message) === null || _g === void 0 ? void 0 : _g.stickerMessage) ? 'sticker' :
                                                ((_h = msg.message) === null || _h === void 0 ? void 0 : _h.contactMessage) ? 'contact' :
                                                    ((_j = msg.message) === null || _j === void 0 ? void 0 : _j.locationMessage) ? 'location' :
                                                        'other';
                        prometheus.recordMessageReceived(messageType);
                        // Record processing duration
                        const processingTime = Date.now() - msg.messageTimestamp * 1000;
