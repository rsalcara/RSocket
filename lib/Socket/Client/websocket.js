...
class WebSocketClient extends types_1.AbstractSocketClient {
    ...
    async connect() {
        ...
        prometheus === null || prometheus === void 0 ? void 0 : prometheus.recordWebSocketConnection('connecting');
        ...
        for (const event of events) {
            ...
            const listener = (...args) => {
                ...
                if (event === 'open') {
                    ...
                    prometheus === null || prometheus === void 0 ? void 0 : prometheus.recordWebSocketConnection('connected');
                    prometheus === null || prometheus === void 0 ? void 0 : prometheus.recordWebSocketConnectionDuration(connectionDuration);
                }
                else if (event === 'error') {
                    prometheus === null || prometheus === void 0 ? void 0 : prometheus.recordWebSocketConnection('error');
                }
                else if (event === 'close') {
                    prometheus === null || prometheus === void 0 ? void 0 : prometheus.recordWebSocketConnection('closed');
                }
    ...
    async close() {
        ...
        const prometheus = (0, prometheus_metrics_1.getPrometheus)();
        prometheus === null || prometheus === void 0 ? void 0 : prometheus.recordWebSocketConnection('closing');
        /**
