    ...
    switch (event) {
        ...
        case 'type_mismatch_flush':
            console.log(`[BAILEYS] ⚡ Type mismatch flush - emitting buffered messages early`, {
                bufferedType: details === null || details === void 0 ? void 0 : details.bufferedType,
                newType: details === null || details === void 0 ? void 0 : details.newType,
                messageCount: details === null || details === void 0 ? void 0 : details.messageCount
            });
            break;
    }
}
