 ...
 */
import { createBaileysLogger, getBaileysLogLevel } from './structured-logger.js';
/**
 ...
 */
export function getStructuredLogger(baseLogger) {
 ...
 * ```
 */
export function setStructuredLogger(baseLogger) {
 ...
 * ```
 */
export function adaptedLog(category, level, data, message) {
 ...
 */
export function isStructuredLogger(logger) {
