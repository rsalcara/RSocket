...
exports.getBaileysLogLevel = getBaileysLogLevel;
 ...
 * ```
 */
function createBaileysLogger(config) {
    ...
    function withTraceContext(obj) {
        if (!includeTraceContext)
            return obj;
        const ctx = (0, trace_context_1.getTraceContext)();
        if (!ctx)
            return obj;
        return {
            traceId: ctx.traceId,
    ...
    return {
        ...
        logConnection(event, data) {
            ...
            const logData = withTraceContext({
                event,
                sessionName: data === null || data === void 0 ? void 0 : data.sessionName,
        ...
        logPreKeys(event, data) {
            if (!isBaileysLogEnabled())
                return;
            const messages = {
                uploaded: `PreKeys uploaded: ${data === null || data === void 0 ? void 0 : data.count} keys`,
                low: `PreKey count low: ${data === null || data === void 0 ? void 0 : data.count} (uploading more...)`,
