...
import { logEventBuffer, logBufferMetrics } from './baileys-logger.js';
import { getPrometheus } from './prometheus-metrics.js';
...
export const makeEventBuffer = (logger) => {
    ...
    function flush(force = false) {
        ...
        if (BUFFER_CONFIG.ENABLE_ADAPTIVE_FLUSH) {
            updateAdaptiveMetrics(adaptiveMetrics, itemsBeforeFlush, flushDuration, BUFFER_CONFIG);
