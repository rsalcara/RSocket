...
class BaileysPrometheusMetrics {
    ...
    initializeMetrics() {
        ...
        this.bufferDestroyedTotal = new prom_client_1.Counter({
        ...
        this.bufferFinalFlushTotal = new prom_client_1.Counter({
        ...
        this.bufferActiveCount = new prom_client_1.Gauge({
        ...
        this.messageTypeMismatchFlushTotal = new prom_client_1.Counter({
        ...
        // ============================================
        this.preKeyUploadsTotal = new prom_client_1.Counter({
            name: `${prefix}prekey_uploads_total`,
            help: 'Total number of pre-key upload operations',
            registers: [this.registry]
        });
        this.preKeyUploadCount = new prom_client_1.Counter({
        ...
        // ============================================
        this.lidMigrationTotal = new prom_client_1.Counter({
        ...
        // ============================================
        this.offlineNotificationsTotal = new prom_client_1.Counter({
        ...
        // ============================================
        this.websocketConnectionsTotal = new prom_client_1.Counter({
            name: `${prefix}websocket_connections_total`,
            help: 'Total number of WebSocket connection state changes',
            labelNames: ['state'],
            registers: [this.registry]
        });
        this.websocketConnectionDuration = new prom_client_1.Histogram({
    ...
    recordBufferDestroyed(reason, hadPendingFlush) {
        ...
        if (!this.config.enabled)
            return;
        (_a = this.bufferDestroyedTotal) === null || _a === void 0 ? void 0 : _a.inc({
            reason,
    ...
    recordBufferFinalFlush(itemsCount) {
        ...
        if (!this.config.enabled)
            return;
        (_a = this.bufferFinalFlushTotal) === null || _a === void 0 ? void 0 : _a.inc({
    ...
    updateBufferActiveCount(count) {
        ...
        if (!this.config.enabled)
            return;
        (_a = this.bufferActiveCount) === null || _a === void 0 ? void 0 : _a.set(count);
    }
    /**
    ...
    recordMessageTypeMismatchFlush(bufferedType, newType) {
        ...
        if (!this.config.enabled)
            return;
        (_a = this.messageTypeMismatchFlushTotal) === null || _a === void 0 ? void 0 : _a.inc({ buffered_type: bufferedType, new_type: newType });
    }
    /**
     * Update cache size
     */
    ...
    recordPreKeyUpload(count) {
        ...
        if (!this.config.enabled)
            return;
        (_a = this.preKeyUploadsTotal) === null || _a === void 0 ? void 0 : _a.inc();
        (_b = this.preKeyUploadCount) === null || _b === void 0 ? void 0 : _b.inc(count);
    }
    /**
    ...
    recordLIDMigration(status) {
        ...
        if (!this.config.enabled)
            return;
        (_a = this.lidMigrationTotal) === null || _a === void 0 ? void 0 : _a.inc({ status });
    }
    /**
    ...
    recordOfflineNotifications(count) {
        ...
        if (!this.config.enabled)
            return;
        (_a = this.offlineNotificationsTotal) === null || _a === void 0 ? void 0 : _a.inc(count);
    }
    /**
    ...
    recordWebSocketConnection(state) {
        ...
        if (!this.config.enabled)
            return;
        (_a = this.websocketConnectionsTotal) === null || _a === void 0 ? void 0 : _a.inc({ state });
    }
    /**
    ...
    recordWebSocketConnectionDuration(durationMs) {
        ...
        if (!this.config.enabled)
            return;
        (_a = this.websocketConnectionDuration) === null || _a === void 0 ? void 0 : _a.observe(durationMs);
    }
    /**
